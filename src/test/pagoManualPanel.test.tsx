...
vi.mock("@/lib/pagoManual", async () => {
  ...
  return { ...real, confirmarPagoManual: (...a: unknown[]) => confirmar(...a) };
});
...
describe("pantalla de pago con Yape/Plin", () => {
  ...
  it("al confirmar avisa a la base y solo entonces da por hecho el paso", async () => {
    const onListo = vi.fn();
  ...
  it("si la confirmación falla NO se cierra: el usuario tiene que poder reintentar", async () => {
