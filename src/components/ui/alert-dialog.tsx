...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mismas medidas que DialogContent (ui/dialog.tsx): `dvh` para seguir al
        // WebView cuando el teclado lo encoge, y centrado dentro del área segura
        // para que el borde superior no quede bajo el notch (MOB-05).
