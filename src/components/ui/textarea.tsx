...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => {
  return (
    <textarea
      className={cn(
        // `text-base` (16px) en móvil y `text-sm` desde md, igual que Input: por
        // debajo de 16px iOS hace auto-zoom al enfocar el campo y descuadra la
        // pantalla. Antes no se notaba porque el viewport bloqueaba el zoom.
