  ...
  return (
    ...
    <header className="w-full z-50 bg-card border-b border-border sticky top-0 pt-safe shadow-[0_1px_0_0_hsl(var(--border))]">
      <div className="container mx-auto flex items-center gap-3 lg:gap-8 h-16 md:h-[76px] px-3 md:px-6">
        ...
        <form
          onSubmit={submit}
          className="hidden 2xl:flex flex-1 min-w-0 max-w-xl items-center bg-muted/50 border border-border rounded-none overflow-hidden focus-within:ring-2 focus-within:ring-secondary/30 focus-within:border-secondary/40 focus-within:bg-card transition-all h-11"
        >
